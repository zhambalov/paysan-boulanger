...
function _addToCart() {
  _addToCart = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(productId, quantity) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          // Optionally, you can update the UI here to reflect the item added to the cart
          _context2.next = 13;
          break;
        case 10:
          _context2.prev = 10;
...
function fetchCartItems() {
  return _fetchCartItems.apply(this, arguments);
}
function _fetchCartItems() {
  _fetchCartItems = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
...
document.getElementById('loginForm').addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var username, password, response, errorData;
...
// Ensure DOM is fully loaded before setting up buttons
document.addEventListener('DOMContentLoaded', function () {
  setupButtons();
  // You might want to call fetchCartItems here if you want to load cart items on page load
  fetchCartItems();
});
